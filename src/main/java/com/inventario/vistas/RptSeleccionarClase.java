...
import com.inventario.controladores.ClaseControlador;
 ...
 * @author RyuujiMD
 */
public class RptSeleccionarClase extends javax.swing.JInternalFrame {

    /**
     * Creates new form RptSeleccionarAmbiente
     */
    private static RptSeleccionarClase instancia;
    
    public static RptSeleccionarClase getInstancia(){
        if(instancia == null){
            instancia = new  RptSeleccionarClase();
        }
        return instancia;
    }
    
    private RptSeleccionarClase() {
        initComponents();
        listar();
    }
    ...
    private void chkTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkTodosActionPerformed
        ...
        this.tblClase.setEnabled(!seleccionado);
        if(!seleccionado){
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        lista.clear();
        lista.addAll(claseControlador.clasesXNombre(this.txtBusqueda.getText()));
    ...
    private void btnVerReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerReporteActionPerformed
        ...
        if(chkTodos.isSelected()){
            file = new File("reportes/PorClases.jasper");
        }else{
            int fila = tblClase.getSelectedRow();
            if(fila != -1){
                file = new File("reportes/PorClaseDetallado.jasper");
                parametros.put("idclase", lista.get(fila).getId().intValue());
            }
        }
        try {
            if(file != null){
            ...
            Logger.getLogger(RptSeleccionarClase.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void listar() {
        ...
        BeanProperty bNombre = BeanProperty.create("clase");
        BeanProperty bResponsable = BeanProperty.create("codigo");

        binding.addColumnBinding(bNombre).setColumnName("CLASE").setEditable(false);
        binding.addColumnBinding(bResponsable).setColumnName("CODIGO").setEditable(false);
